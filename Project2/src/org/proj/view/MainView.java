	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == profileOkBtn) {
			int yn = JOptionPane.showConfirmDialog(this,
					new JLabel("프로필을 수정하시겠습니까?", javax.swing.SwingConstants.CENTER), "확인", JOptionPane.YES_NO_OPTION,
			...
			if (yn == 0) {
				...
				try {
					...
					JOptionPane.showMessageDialog(this, new JLabel("나이는 숫자만 입력하세요!", javax.swing.SwingConstants.CENTER),
							"정보 수정", JOptionPane.PLAIN_MESSAGE);
					textage.setText(userAgedb + "");
					return;
				}
				if (userNamedb.length() != 0 && userPassdb.length() != 0) {
					...
					JOptionPane.showMessageDialog(this, new JLabel("내용을 전부 입력해주세요", javax.swing.SwingConstants.CENTER),
							"정보 수정", JOptionPane.PLAIN_MESSAGE);
				}
			}
		}
...
//			Btn[i].setEnabled();
		...
		if (e.getSource() == exitBtn) {
			...
			int yn = JOptionPane.showConfirmDialog(this, new JLabel("로그아웃 하시겠습니까?", javax.swing.SwingConstants.CENTER),
