...
public class Test01 extends JFrame {
   ...
   static {
      ...
      record.add(new Info("user1", 9, 15, "2022-01-06"));
      record.add(new Info("user1", 17, 20, "2022-01-08"));
      record.add(new Info("user1", 14, 20, "2022-01-10"));
      record.add(new Info("user1", 6, 10, "2022-01-11"));
   }
